<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="Registration.Admin.Default" %>
    ...
    <div class="row">
        <div class="col-sm-12 table-responsive">
            ...
            <asp:GridView ID="grdUsers" runat="server" DataKeyNames="Id"
                 ...
                 ItemType="Registration.Models.ApplicationUser"
        ...
        <div class="col-sm-6">
            <asp:DetailsView ID="dvUsers" runat="server" DataKeyNames="Id" 
                ...
                SelectMethod="dvUsers_GetItem" 
                Method="dvUsers_UpdateItem" 
